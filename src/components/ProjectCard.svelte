...
<div class="card">
    ...
    <div class="links">
        {#if repo}<a href={repo} target="_blank">Código</a>{/if}
        {#if apiRepo} <a href={apiRepo} target="_blank">API</a>{/if}
        {#if demo}<a href={demo} target="_blank">Demo</a>{/if}
    </div>
</div>
...
{#if modalImg}
    <div class="modal" on:click|self={closeModal}>
        <div class="modal-content">
            <button class="close" on:click={closeModal} aria-label="Cerrar">&times;</button>
